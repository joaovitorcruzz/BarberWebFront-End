                ...
                <Flex direction="column" alignItems="flex-start" justifyContent="flex-start">
                    ...
                    <Flex mt={4} maxW="700px" pt={8} pb={8} w="100%" bg="barber.400" direction="column" align="center" justify="center">
                        ...
                        <Flex w="85%" direction="column">
                            <Input placeholder="Nome do corte" bg="gray.900" mb={3} size="lg" type="text" w="100%" />

                            <Input placeholder="Valor do seu corte ex 45.90" bg="gray.900" mb={3} size="lg" type="text" w="100%" />
