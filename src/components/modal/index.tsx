            ...
            <ModalContent bg="barber.400" color='white'>
                ...
                <ModalBody>
                    <Flex align='center' mb={3}>
                        ...
                        <Text color='white' ml={3} fontSize='2xl' fontWeight='bold'>{data?.customer}</Text>
                    </Flex>

                    <Flex align='center' mb={3}>
                        <FiScissors size={28} color='#FFF' />
                        <Text color='white' ml={3} fontSize='large' fontWeight='bold'>{data?.haircut.name}</Text>
                    </Flex>

                    <Flex align='center' mb={3}>
                        <FaMoneyBillAlt size={28} color='#46ef75' />
                        <Text color='white' ml={3} fontSize='large' fontWeight='bold'>R$ {data?.haircut?.price}</Text>
                    </Flex>
